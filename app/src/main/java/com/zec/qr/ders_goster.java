...
public class ders_goster extends ListActivity implements OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.ders_goster);
        ...
        TextView salonAdi=(TextView)findViewById(R.id.salon_adi);
